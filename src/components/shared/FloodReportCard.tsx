...
import { MapPin, Clock, Waves, CarFront } from "lucide-react";
...
export default function FloodReportCard({
  ...
  return (
    <div
      className={cn(
        "bg-white rounded-xl border border-slate-100 shadow-card p-4 transition-all duration-200 hover:shadow-card-hover",
        className,
      )}
    >
